...
namespace Nexora.Api.Controllers
{
    public class AuthController(IAuthService _authService) : BaseApiController
    {
        ...
        {
            return CreatedResult(await _authService.Register(request));
        }
        ...
        {
            return OkResult(await _authService.Login(request));
        }
        ...
        {
            return OkResult(await _authService.RefreshToken(request));
        }
        ...
        {
            return OkResult("This service returned 200");
        }
    }
}