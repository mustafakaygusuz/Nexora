...
{
    public sealed class RateLimiterConfigurationModel
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>
        /// A rate limit configuration model value for holding rate limit configurations.
        /// </value>
        public List<RateLimitConfigurationModel> RateLimits { get; set; } = [];
    }

    public sealed class RateLimitConfigurationModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the endpoints that rate limit will be applied, if list is empty that means it's global.
        /// </summary>
        /// <value>A rate limit endpoint configuration model value with the http endpoint and verbs.</value>
        public List<RateLimitEndpointConfigurationModel>? Endpoints { get; set; } = [];
    ...
    public class RateLimitEndpointConfigurationModel
    {
        /// <summary>
        /// Gets or sets the HTTP endpoint regex pattern that holds the path.
        /// </summary>
        /// <value>A string value with the path pattern.</value>
        public required string EndpointPathPattern { get; set; }

        /// <summary>
        /// Gets or sets the HTTP verb like POST, GET etc.
        /// </summary>
        /// <value>A string value with the HTTP verb.</value>
